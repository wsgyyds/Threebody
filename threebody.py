...
f_num1=0
def f_way1():#文件夹方法
    global f_num1,e_file1
    f_num1=f_num1+1
    try:
        os.mkdir(e_file1.get()+'\\threebody\\threebody'+str(f_num1))
        
    except FileExistsError:
        f_way1()

def window():#创建窗口
    global f_num1,name,f,e_m1,e_m2,e_m3,e_t,e_v1x,e_v2x,e_v3x,e_v1y,e_v2y,e_v3y,e_G,e_x1,e_x2,e_x3,e_y1,e_y2,e_y3,e_waittime,x1,y1,x2,y2,x3,y3,v1_x,v1_y,v2_x,v3_x,v3_y,v2_y,write_num,e_runtime,e_file,window,e_file1
    window=tk.Tk()
    ...
    mr_t=tk.StringVar(value=0.00001)
    ...
    mr_waittime=tk.StringVar(value=5000)
    ...
    mr_file1=tk.StringVar(value='C:\\Users\\'+name+'\\Desktop')
    e_file1=tk.Entry(window,show=None,width=53,textvariable=mr_file1)
    e_file1.place(x=115,y=475)
    ...
    l_file1=tk.Label(window,text="输出路径：",width=15,height=2)
    l_file1.place(x=0,y=465)
...
def run1():#创建新的运算
    ...
    try:
        os.mkdir(e_file1.get()+'\\threebody')
        try:
            os.mkdir(e_file1.get()+'\\threebody\\threebody0')
        except FileExistsError:
            f_way1()
    except FileExistsError:
        print("")
    ...
    f0=open(e_file1.get()+'\\threebody\\threebody'+str(f_num1)+'\\threebody0.txt', mode='x+')    
    f1=open(e_file1.get()+'\\threebody\\threebody'+str(f_num1)+'\\threebody1.txt', mode='x+')
    f2=open(e_file1.get()+'\\threebody\\threebody'+str(f_num1)+'\\threebody2.txt', mode='x+')
...
def import1():#导入初始数值
    ...
    global f_num1,name,f,e_m1,e_m2,e_m3,e_t,e_v1x,e_v2x,e_v3x,e_v1y,e_v2y,e_v3y,e_G,e_x1,e_x2,e_x3,e_y1,e_y2,e_y3,e_waittime,write_num,e_runtime,e_file1
    window=tk.Tk()
    window.title("Threebody")
    window.geometry('500x600')
    b_now=tk.Button(window,text="全新的计算",width=15,height=2,command=run1)
